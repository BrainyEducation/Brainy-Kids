...
module.exports = (app, passport) => {
	...
	app.post(
		...
		[
			...
			check('student', 'Must contain an student.').exists(),
			check('program', 'Must contain an program.').exists(),
			check('focus_item', 'Must contain an focus_item.').optional(),
			check('focus_item_name', 'Must contain an focus_item.').optional(),
			check('focus_item_unit', 'Must contain an focus_item.').optional(),
			check('focus_item_subunit', 'Must contain an focus_item.').optional(),
